...
# â”€â”€ Public: start jobs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Shared-directory index helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        for h, files in dup_groups.items():
            ...
            for f in files:
                ...
                try:
                    ...
                    entry.link_count = (entry.link_count or 0) + 1
                    linked_count += 1
                    # Net savings: (copies - 1) Ă— size; we count per-link but subtract
    ...
    try:
        ...
        for i, link in enumerate(links):
            ...
            try:
                ...
                # Copy canonical â†’ temp next to target, then swap
...
def get_db_stats(db) -> dict:
    ...
    # saved = sum over all entries of (link_count Ă— size_bytes)
